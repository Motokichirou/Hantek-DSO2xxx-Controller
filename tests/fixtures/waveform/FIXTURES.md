...
Кадр = HEADER, затем по одному DATA-пакету на каждый включённый канал (по возрастанию: CH1, затем CH2). Читать DATA-пакеты пока `uploaded < total`. `total = N_каналов × points + 99`.
